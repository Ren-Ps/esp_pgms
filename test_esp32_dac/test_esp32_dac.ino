...
int frequency_step = 38;  // Frequency step for CW generator //39 will give 5058Hz //38 will 4929
...
void dac_cosine_enable(dac_channel_t channel)
{
    ...
    switch(channel) {
        ...
        case DAC_CHANNEL_2:
            ...
            break;
        default :
           Serial.printf("Channel %d\n", channel);//comment-remove 'Serial.' only to use apart from arduino ide
    }
}
...
*/
void setup() //app_main() //uncomment this to use apart from arduino ide while remove 'setup()' only. also, place this function after loop function
{
  Serial.begin(115200); delay(10); //comment this line to use apart from arduino ide
   ...
   // xTaskCreate(dactask, "dactask", 1024*3, NULL, 10, NULL); //uncomment this line to use apart from arduino ide
}
 ...
 *
*/
void loop() //dactask(void* arg) //uncomment this to use apart from arduino ide while remove 'loop()' only.
{
    while(1){
        ...
        //comment-remove 'Serial.' only to use apart from arduino ide

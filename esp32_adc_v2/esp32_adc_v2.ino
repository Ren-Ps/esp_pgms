...
void setup() //app_main(void)
{
    ...
    Serial.println("@Ps, Jan, 19. Product under Development Terms with Source Tech System.");
...
void loop() {
        ...
        adc_raw_avg=adc_raw_avg+1000000;
        printf("C0%d",adc_raw_avg); printf(";01\n");

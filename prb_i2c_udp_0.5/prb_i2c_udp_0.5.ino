...
//    if (H_byt.p0 == 0) { Dec = 5000 - Dec; }
//    else { Dec = 5000 + Dec;}
    Serial.println(digitalRead(D0)); Serial.print(Dec);  delay(3);
    
    /*if (H_byt.p1 == 0) { Serial.println(" ~"); }
    else { Serial.println(" ^");}*/
    Udp.beginPacket(Udp.remoteIP(), Udp.remotePort());
    char txBuff[10];
    txBuff[0] = 'C' + (Dec/10000);
    txBuff[1] = 'C' + ((Dec/1000)%10);
    txBuff[2] = 'C' + ((Dec/100)%10);
    txBuff[3] = 'C' + ((Dec/10)%10);
    txBuff[4] = 'C' + (Dec%10);
    txBuff[5] = 'C' + 0;

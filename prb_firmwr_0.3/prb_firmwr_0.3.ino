...
char inPacket[255], slctNw;  // buffer for incoming packets
...
void setup() {
  ...
  Serial.print("\n\t....Scan Done!\nNOTE: a. * Stands for the Network is Password Secured.");
  Serial.print("\n      b. In brackets Network Strength is shown.");
  Serial.print("\n      c. Network Strengths are in (100+ actual dBm). ");
  Serial.print("\n      d. For Open type Network, Enter ';' only when password is asked.");
  Serial.print("\n      e. Always Enter ';' at the end of respective input on Serial is asked.");
  Serial.print("\n\nEnter Choice of Network: ");
  Serial.flush();
  msg="";
  while (!Serial.available()){
    slctNw = Serial.read(); 
    Serial.println(slctNw);}
    //if( (ScnNw+1) <= slctNw) { Serial.print("\n wrong choice");}
    switch(slctNw){
      case '1' : msg=WiFi.SSID(0); Serial.print("\n SSID: 1. "); break;//msg.toCharArray(ssid,32);
      case '2' : msg=WiFi.SSID(1); Serial.print("\n SSID: 2. "); break;//msg.toCharArray(ssid,32);
      case '3' : msg=WiFi.SSID(2); Serial.print("\n SSID: 3. "); break;//msg.toCharArray(ssid,32);
      case '4' : msg=WiFi.SSID(3); Serial.print("\n SSID: 4. "); break;// msg.toCharArray(ssid,32);
      case '5' : msg=WiFi.SSID(4); Serial.print("\n SSID: 5. "); break;// msg.toCharArray(ssid,32);
      case '6' : msg=WiFi.SSID(5); Serial.print("\n SSID: 6. "); break;// msg.toCharArray(ssid,32);
      case '7' : msg=WiFi.SSID(6); Serial.print("\n SSID: 7. "); break;
      case '8' : msg=WiFi.SSID(7); Serial.print("\n SSID: 8. "); break;
      case '9' : msg=WiFi.SSID(8); Serial.print("\n SSID: 9. "); break;
      case '0' : msg=WiFi.SSID(9); Serial.print("\n SSID: 10. "); break;
    }
  Serial.println(msg);  delay(10); 
  msg.toCharArray(ssid,32); delay(10);  msg="";
  //for (int q=0; q<33; q++) { Serial.print("\t array ssid: "); Serial.print(" "+ssid[q]);}
  Serial.print("\nEnter Password: "); 
  Serial.flush();
  while(1){

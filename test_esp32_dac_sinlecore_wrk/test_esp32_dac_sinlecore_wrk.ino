  ...
  if (Serial.available()) {
    if(SerialBT.find("OP")){
      if(SerialBT.find("HI")){
        ...
        int pin = SeRecv.toInt();
        digitalWrite(pin,HIGH);
        }
        else if(Serial.find("LO")){
        ...
        digitalWrite(pin,LOW);
            ...
            String Selrecv = Serial.readStringUntil('\n');
            SerialBT.println(Selrecv);
      }
    }
    if (SerialBT.available()) {
      if (SerialBT.find("OP")){ Serial.println("op");
        if(SerialBT.find("HI")){
          Serial.println("hi");
          String BTrecv=SerialBT.readStringUntil('\n');
          int pin = BTrecv.toInt();
          Serial.print(pin);
          digitalWrite(pin,HIGH);
          }
          else if(SerialBT.find("LO")){
            Serial.println("lo");
          String BTrecv=SerialBT.readStringUntil('\n');
          int pin = BTrecv.toInt();
          Serial.print(pin);

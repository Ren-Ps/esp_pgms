...
/*void callback(esp_spp_cb_event_t event, esp_spp_cb_param_t *param){
 ...
 void Task2code( void * pvParameters ){
  ...
  Serial.println(xPortGetCoreID()); delay(1);
   ...
   // }
      ...
      if( Serial.find("CMD"))
      {
        Serial.println("cmd @ find found");
        if(Serial.find("OP")){
          Serial.println("op @ find @ cmd @ find found");
          if(Serial.find("H"))
          {
            ...
            int pin = str.toInt();
            switch (pin){
              case 001: digitalWrite(15, HIGH);Serial.println("pin 1-15 high");break;
              case 002: digitalWrite(2, HIGH);Serial.println("pin 2-2 high");break;
              case 003: digitalWrite(0, HIGH);Serial.println("pin 3-0 high");break;
              case 004: digitalWrite(4, HIGH);Serial.println("pin 4-4 high");break;
              case 005: digitalWrite(16, HIGH);Serial.println("pin 5-16 high");break;
              default: break;
            }
            }
            if(Serial.find("L"))
          {
            ...
            int pin = str.toInt();
            switch (pin){
              case 001: digitalWrite(15, LOW);Serial.println("pin 1-15 low");break;
              case 002: digitalWrite(2, LOW);Serial.println("pin 2-2 low");break;
              case 003: digitalWrite(0, LOW);Serial.println("pin 3-0 low");break;
              case 004: digitalWrite(4, LOW);Serial.println("pin 4-4 low");break;
              case 005: digitalWrite(16, LOW);Serial.println("pin 5-16 low");break;
              default: break;
            }
            }
            }
